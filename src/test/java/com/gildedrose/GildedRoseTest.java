...
// ********** Tests from requirements ***********
  ...
  void testQualityDecreasesTwice() {
      ...
      app.updateQuality();
      assertThat(element.toString(), is("Any, -1, 0"));
  }
  ...
  void testQualityAtZero() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Any, 0, 0"));
  }
  ...
  void testAgedBrieQualityIncreasesBy1() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Aged Brie, 0, 41"));
  }
  ...
  void testSulfurasQualityAndSellInConstant() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Sulfuras, Hand of Ragnaros, 9, 80"));
  }
  ...
  void testBackstageQualityIncreasesBy1() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Backstage passes to a TAFKAL80ETC concert, 11, 21"));
  }
  ...
  void testBackstageQualityIncreasesBy2() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Backstage passes to a TAFKAL80ETC concert, 10, 22"));
  }
  ...
  void testBackstageQualityIncreasesBy3() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Backstage passes to a TAFKAL80ETC concert, 5, 23"));
  }
  @Test
  ...
  void testBackstageQualityNotRaisedMaxFifty() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Backstage passes to a TAFKAL80ETC concert, 7, 50"));
    }
  @Test
  ...
  void testBackstageQualityIncreasesLessThan3MaxFifty() {
        ...
        GildedRose app = new GildedRose(new Item[] {element});
        app.updateQuality();
        assertThat(element.toString(), is("Backstage passes to a TAFKAL80ETC concert, 0, 50"));
    }
  ...
  void testConjuredDecreasesBy2(){
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Conjured, 0, 38"));
  }
  ...
  void testConjuredDecreasesBy4(){
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Conjured, -1, 36"));
  }
  @Test
  ...
  void testConjuredDecreasesBy2Max50(){
        ...
        GildedRose app = new GildedRose(new Item[] {element});
        app.updateQuality();
        assertThat(element.toString(), is("Conjured, -1, 0"));
    }
  ...
  void testConjuredStayZero(){
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Conjured, 9, 0"));
    }
...
// ********** Tests remaining to cover the entire code **********
  ...
  void testAgedBrieQualityIncreasesTwice() {
      ...
      GildedRose app = new GildedRose(new Item[] {element});
      app.updateQuality();
      assertThat(element.toString(), is("Aged Brie, -1, 12"));
  }
  ...
  void testAgedBrieQualityIncreasesBy1Max50() {
        ...
        GildedRose app = new GildedRose(new Item[] {element});
        app.updateQuality();
        assertThat(element.toString(), is("Aged Brie, -1, 50"));
    }
  ...
  void testSulfurasQualityAndSellInConstantBelowZero() {
        ...
        GildedRose app = new GildedRose(new Item[] {element});
        app.updateQuality();
        assertThat(element.toString(), is("Sulfuras, Hand of Ragnaros, -2, 80"));
    }
...
// ***** Test to complete Pitest *****
  ...
  void testQualityDecreasesBy1MinZero() {
    ...
    void testQualityDecreasesBy2MinZero() {
        ...
        GildedRose app = new GildedRose(new Item[] {element});
        app.updateQuality();
        assertThat(element.toString(), is("Any, 0, 1"));
    }
}
